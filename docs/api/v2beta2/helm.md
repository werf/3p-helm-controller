...
<ul class="simple">
<li>
<a href="#helm.werf.io%2fv2beta2">helm.werf.io/v2beta2</a>
</li>
</ul>
<h2 id="helm.werf.io/v2beta2">helm.werf.io/v2beta2</h2>
<p>Package v2beta2 contains API Schema definitions for the helm v2beta2 API group</p>
Resource Types:
<ul class="simple"><li>
<a href="#helm.werf.io/v2beta2.HelmRelease">HelmRelease</a>
</li></ul>
<h3 id="helm.werf.io/v2beta2.HelmRelease">HelmRelease
</h3>
...
string</td>
<td>
<code>helm.werf.io/v2beta2</code>
</td>
</tr>
<tr>
<td>
...
<code>spec</code><br>
<em>
<a href="#helm.werf.io/v2beta2.HelmReleaseSpec">
HelmReleaseSpec
</a>
</em>
</td>
...
<code>chart</code><br>
<em>
<a href="#helm.werf.io/v2beta2.HelmChartTemplate">
HelmChartTemplate
</a>
</em>
</td>
...
<em>
<a href="#helm.werf.io/v2beta2.CrossNamespaceSourceReference">
...
<em>
<a href="#helm.werf.io/v2beta2.DriftDetection">
DriftDetection
</a>
</em>
</td>
...
<em>
<a href="#helm.werf.io/v2beta2.Install">
Install
</a>
</em>
</td>
...
<em>
<a href="#helm.werf.io/v2beta2.Upgrade">
Upgrade
</a>
</em>
</td>
...
<code>test</code><br>
<em>
<a href="#helm.werf.io/v2beta2.Test">
Test
</a>
</em>
</td>
...
<em>
<a href="#helm.werf.io/v2beta2.Rollback">
Rollback
</a>
</em>
</td>
...
<em>
<a href="#helm.werf.io/v2beta2.Uninstall">
Uninstall
</a>
</em>
</td>
...
<em>
<a href="#helm.werf.io/v2beta2.ValuesReference">
[]ValuesReference
</a>
</em>
</td>
...
<em>
<a href="#helm.werf.io/v2beta2.PostRenderer">
[]PostRenderer
</a>
</em>
</td>
...
<code>status</code><br>
<em>
<a href="#helm.werf.io/v2beta2.HelmReleaseStatus">
HelmReleaseStatus
</a>
</em>
</td>
...
<h3 id="helm.werf.io/v2beta2.CRDsPolicy">CRDsPolicy
(<code>string</code> alias)</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta2.Install">Install</a>, 
<a href="#helm.werf.io/v2beta2.Upgrade">Upgrade</a>)
</p>
<p>CRDsPolicy defines the install/upgrade approach to use for CRDs when
installing or upgrading a HelmRelease.</p>
<h3 id="helm.werf.io/v2beta2.CrossNamespaceObjectReference">CrossNamespaceObjectReference
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta2.HelmChartTemplateSpec">HelmChartTemplateSpec</a>)
</p>
...
<h3 id="helm.werf.io/v2beta2.CrossNamespaceSourceReference">CrossNamespaceSourceReference
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta2.HelmReleaseSpec">HelmReleaseSpec</a>)
</p>
...
<h3 id="helm.werf.io/v2beta2.DriftDetection">DriftDetection
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta2.HelmReleaseSpec">HelmReleaseSpec</a>)
...
<code>mode</code><br>
<em>
<a href="#helm.werf.io/v2beta2.DriftDetectionMode">
DriftDetectionMode
</a>
</em>
</td>
...
<code>ignore</code><br>
<em>
<a href="#helm.werf.io/v2beta2.IgnoreRule">
[]IgnoreRule
</a>
</em>
</td>
...
<h3 id="helm.werf.io/v2beta2.DriftDetectionMode">DriftDetectionMode
(<code>string</code> alias)</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta2.DriftDetection">DriftDetection</a>)
</p>
...
currently existing in the cluster.</p>
<h3 id="helm.werf.io/v2beta2.Filter">Filter
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta2.Test">Test</a>)
</p>
...
<h3 id="helm.werf.io/v2beta2.HelmChartTemplate">HelmChartTemplate
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta2.HelmReleaseSpec">HelmReleaseSpec</a>)
...
<code>metadata</code><br>
<em>
<a href="#helm.werf.io/v2beta2.HelmChartTemplateObjectMeta">
...
<code>spec</code><br>
<em>
<a href="#helm.werf.io/v2beta2.HelmChartTemplateSpec">
...
<em>
<a href="#helm.werf.io/v2beta2.CrossNamespaceObjectReference">
...
<code>verify</code><br>
<em>
<a href="#helm.werf.io/v2beta2.HelmChartTemplateVerification">
...
<h3 id="helm.werf.io/v2beta2.HelmChartTemplateObjectMeta">HelmChartTemplateObjectMeta
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta2.HelmChartTemplate">HelmChartTemplate</a>)
</p>
...
<h3 id="helm.werf.io/v2beta2.HelmChartTemplateSpec">HelmChartTemplateSpec
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta2.HelmChartTemplate">HelmChartTemplate</a>)
...
<h3 id="helm.werf.io/v2beta2.HelmChartTemplateVerification">HelmChartTemplateVerification
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta2.HelmChartTemplateSpec">HelmChartTemplateSpec</a>)
...
<h3 id="helm.werf.io/v2beta2.HelmReleaseSpec">HelmReleaseSpec
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta2.HelmRelease">HelmRelease</a>)
...
<h3 id="helm.werf.io/v2beta2.HelmReleaseStatus">HelmReleaseStatus
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta2.HelmRelease">HelmRelease</a>)
...
<em>
<a href="#helm.werf.io/v2beta2.Snapshots">
Snapshots
</a>
</em>
</td>
...
<em>
<a href="#helm.werf.io/v2beta2.ReleaseAction">
ReleaseAction
</a>
</em>
</td>
...
<h3 id="helm.werf.io/v2beta2.IgnoreRule">IgnoreRule
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta2.DriftDetection">DriftDetection</a>)
...
<h3 id="helm.werf.io/v2beta2.Install">Install
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta2.HelmReleaseSpec">HelmReleaseSpec</a>)
...
<em>
<a href="#helm.werf.io/v2beta2.InstallRemediation">
InstallRemediation
</a>
</em>
</td>
...
<code>crds</code><br>
<em>
<a href="#helm.werf.io/v2beta2.CRDsPolicy">
CRDsPolicy
</a>
</em>
</td>
...
<h3 id="helm.werf.io/v2beta2.InstallRemediation">InstallRemediation
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta2.Install">Install</a>)
...
<h3 id="helm.werf.io/v2beta2.Kustomize">Kustomize
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta2.PostRenderer">PostRenderer</a>)
</p>
...
<h3 id="helm.werf.io/v2beta2.PostRenderer">PostRenderer
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta2.HelmReleaseSpec">HelmReleaseSpec</a>)
...
<em>
<a href="#helm.werf.io/v2beta2.Kustomize">
Kustomize
</a>
</em>
</td>
...
<h3 id="helm.werf.io/v2beta2.ReleaseAction">ReleaseAction
(<code>string</code> alias)</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta2.HelmReleaseStatus">HelmReleaseStatus</a>)
</p>
<p>ReleaseAction is the action to perform a Helm release.</p>
<h3 id="helm.werf.io/v2beta2.Remediation">Remediation
</h3>
<p>Remediation defines a consistent interface for InstallRemediation and
UpgradeRemediation.</p>
<h3 id="helm.werf.io/v2beta2.RemediationStrategy">RemediationStrategy
(<code>string</code> alias)</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta2.UpgradeRemediation">UpgradeRemediation</a>)
</p>
<p>RemediationStrategy returns the strategy to use to remediate a failed install
or upgrade.</p>
<h3 id="helm.werf.io/v2beta2.Rollback">Rollback
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta2.HelmReleaseSpec">HelmReleaseSpec</a>)
...
<h3 id="helm.werf.io/v2beta2.Snapshot">Snapshot
</h3>
...
<em>
<a href="#helm.werf.io/v2beta2.TestHookStatus">
TestHookStatus
</a>
</em>
</td>
...
<h3 id="helm.werf.io/v2beta2.Snapshots">Snapshots
...
<h3 id="helm.werf.io/v2beta2.Test">Test
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta2.HelmReleaseSpec">HelmReleaseSpec</a>)
...
<em>
<a href="#helm.werf.io/v2beta2.Filter">
Filter
</a>
</em>
</td>
...
<h3 id="helm.werf.io/v2beta2.TestHookStatus">TestHookStatus
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta2.Snapshot">Snapshot</a>)
</p>
...
<h3 id="helm.werf.io/v2beta2.Uninstall">Uninstall
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta2.HelmReleaseSpec">HelmReleaseSpec</a>)
...
<h3 id="helm.werf.io/v2beta2.Upgrade">Upgrade
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta2.HelmReleaseSpec">HelmReleaseSpec</a>)
...
<code>remediation</code><br>
<em>
<a href="#helm.werf.io/v2beta2.UpgradeRemediation">
UpgradeRemediation
</a>
</em>
</td>
...
<h3 id="helm.werf.io/v2beta2.UpgradeRemediation">UpgradeRemediation
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta2.Upgrade">Upgrade</a>)
...
<em>
<a href="#helm.werf.io/v2beta2.RemediationStrategy">
RemediationStrategy
</a>
</em>
</td>
...
<h3 id="helm.werf.io/v2beta2.ValuesReference">ValuesReference
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta2.HelmReleaseSpec">HelmReleaseSpec</a>)
