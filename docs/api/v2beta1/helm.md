...
<ul class="simple">
<li>
<a href="#helm.werf.io%2fv2beta1">helm.werf.io/v2beta1</a>
</li>
</ul>
<h2 id="helm.werf.io/v2beta1">helm.werf.io/v2beta1</h2>
<p>Package v2beta1 contains API Schema definitions for the helm v2beta1 API group</p>
Resource Types:
<ul class="simple"><li>
<a href="#helm.werf.io/v2beta1.HelmRelease">HelmRelease</a>
</li></ul>
<h3 id="helm.werf.io/v2beta1.HelmRelease">HelmRelease
</h3>
...
string</td>
<td>
<code>helm.werf.io/v2beta1</code>
</td>
</tr>
<tr>
<td>
...
<code>spec</code><br>
<em>
<a href="#helm.werf.io/v2beta1.HelmReleaseSpec">
HelmReleaseSpec
</a>
</em>
</td>
...
<code>chart</code><br>
<em>
<a href="#helm.werf.io/v2beta1.HelmChartTemplate">
HelmChartTemplate
</a>
</em>
</td>
...
<em>
<a href="#helm.werf.io/v2beta1.Install">
Install
</a>
</em>
</td>
...
<em>
<a href="#helm.werf.io/v2beta1.Upgrade">
Upgrade
</a>
</em>
</td>
...
<code>test</code><br>
<em>
<a href="#helm.werf.io/v2beta1.Test">
Test
</a>
</em>
</td>
...
<em>
<a href="#helm.werf.io/v2beta1.Rollback">
Rollback
</a>
</em>
</td>
...
<em>
<a href="#helm.werf.io/v2beta1.Uninstall">
Uninstall
</a>
</em>
</td>
...
<em>
<a href="#helm.werf.io/v2beta1.ValuesReference">
[]ValuesReference
</a>
</em>
</td>
...
<em>
<a href="#helm.werf.io/v2beta1.PostRenderer">
[]PostRenderer
</a>
</em>
</td>
...
<code>status</code><br>
<em>
<a href="#helm.werf.io/v2beta1.HelmReleaseStatus">
HelmReleaseStatus
</a>
</em>
</td>
...
<h3 id="helm.werf.io/v2beta1.CRDsPolicy">CRDsPolicy
...
<h3 id="helm.werf.io/v2beta1.CrossNamespaceObjectReference">CrossNamespaceObjectReference
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta1.HelmChartTemplateSpec">HelmChartTemplateSpec</a>)
</p>
...
<h3 id="helm.werf.io/v2beta1.DeploymentAction">DeploymentAction
</h3>
<p>DeploymentAction defines a consistent interface for Install and Upgrade.</p>
<h3 id="helm.werf.io/v2beta1.HelmChartTemplate">HelmChartTemplate
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta1.HelmReleaseSpec">HelmReleaseSpec</a>)
</p>
...
<code>metadata</code><br>
<em>
<a href="#helm.werf.io/v2beta1.HelmChartTemplateObjectMeta">
...
<code>spec</code><br>
<em>
<a href="#helm.werf.io/v2beta1.HelmChartTemplateSpec">
...
<em>
<a href="#helm.werf.io/v2beta1.CrossNamespaceObjectReference">
...
<code>verify</code><br>
<em>
<a href="#helm.werf.io/v2beta1.HelmChartTemplateVerification">
...
<h3 id="helm.werf.io/v2beta1.HelmChartTemplateObjectMeta">HelmChartTemplateObjectMeta
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta1.HelmChartTemplate">HelmChartTemplate</a>)
</p>
...
<h3 id="helm.werf.io/v2beta1.HelmChartTemplateSpec">HelmChartTemplateSpec
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta1.HelmChartTemplate">HelmChartTemplate</a>)
...
<h3 id="helm.werf.io/v2beta1.HelmChartTemplateVerification">HelmChartTemplateVerification
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta1.HelmChartTemplateSpec">HelmChartTemplateSpec</a>)
...
<h3 id="helm.werf.io/v2beta1.HelmReleaseSpec">HelmReleaseSpec
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta1.HelmRelease">HelmRelease</a>)
...
<h3 id="helm.werf.io/v2beta1.HelmReleaseStatus">HelmReleaseStatus
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta1.HelmRelease">HelmRelease</a>)
...
<h3 id="helm.werf.io/v2beta1.Install">Install
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta1.HelmReleaseSpec">HelmReleaseSpec</a>)
...
<em>
<a href="#helm.werf.io/v2beta1.InstallRemediation">
InstallRemediation
</a>
</em>
</td>
...
<code>crds</code><br>
<em>
<a href="#helm.werf.io/v2beta1.CRDsPolicy">
CRDsPolicy
</a>
</em>
</td>
...
<h3 id="helm.werf.io/v2beta1.InstallRemediation">InstallRemediation
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta1.Install">Install</a>)
...
<h3 id="helm.werf.io/v2beta1.Kustomize">Kustomize
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta1.PostRenderer">PostRenderer</a>)
</p>
...
<h3 id="helm.werf.io/v2beta1.PostRenderer">PostRenderer
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta1.HelmReleaseSpec">HelmReleaseSpec</a>)
...
<em>
<a href="#helm.werf.io/v2beta1.Kustomize">
Kustomize
</a>
</em>
</td>
...
<h3 id="helm.werf.io/v2beta1.Remediation">Remediation
</h3>
<p>Remediation defines a consistent interface for InstallRemediation and
UpgradeRemediation.</p>
<h3 id="helm.werf.io/v2beta1.RemediationStrategy">RemediationStrategy
(<code>string</code> alias)</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta1.UpgradeRemediation">UpgradeRemediation</a>)
</p>
<p>RemediationStrategy returns the strategy to use to remediate a failed install
or upgrade.</p>
<h3 id="helm.werf.io/v2beta1.Rollback">Rollback
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta1.HelmReleaseSpec">HelmReleaseSpec</a>)
...
<h3 id="helm.werf.io/v2beta1.Test">Test
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta1.HelmReleaseSpec">HelmReleaseSpec</a>)
...
<h3 id="helm.werf.io/v2beta1.Uninstall">Uninstall
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta1.HelmReleaseSpec">HelmReleaseSpec</a>)
...
<h3 id="helm.werf.io/v2beta1.Upgrade">Upgrade
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta1.HelmReleaseSpec">HelmReleaseSpec</a>)
...
<code>remediation</code><br>
<em>
<a href="#helm.werf.io/v2beta1.UpgradeRemediation">
UpgradeRemediation
</a>
</em>
</td>
...
<h3 id="helm.werf.io/v2beta1.UpgradeRemediation">UpgradeRemediation
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta1.Upgrade">Upgrade</a>)
...
<em>
<a href="#helm.werf.io/v2beta1.RemediationStrategy">
RemediationStrategy
</a>
</em>
</td>
...
<h3 id="helm.werf.io/v2beta1.ValuesReference">ValuesReference
</h3>
<p>
(<em>Appears on:</em>
<a href="#helm.werf.io/v2beta1.HelmReleaseSpec">HelmReleaseSpec</a>)
